...
import com.guiado.projectbox.adapter.CentersRecyclerViewAdapter
 ...
 */
class RecyclerLoadMoreCentrsHandler(private val countriesViewModel: CentersViewModel,
                                    private val listViewAdapter: CentersRecyclerViewAdapter
) {
