...
import com.guiado.kidangu.databinding.ContentWorldstrryBinding
import com.guiado.kidangu.model.Feed
import com.guiado.kidangu.model.Kural
import com.guiado.kidangu.model.Storiess

class  FragmentWorldStory : AppCompatActivity() {

    lateinit var adView: AdView

    @Transient
    var binding: ContentWorldstrryBinding? = null;
        ...
        super.onCreate(savedInstanceState)
         if (binding == null) {
             binding = DataBindingUtil.setContentView(this,
                 R.layout.content_worldstrry
             )
             val blogUrl  = intent.getSerializableExtra("feed") as String


             var gson = Gson();
             var output =   gson.fromJson(blogUrl, Storiess::class.java)



             val areaViewModel =
                 WorldStoryViewModel(this, this, output)
